          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            >
              <MenuItem key="profile" onClick={handleCloseUserMenu}>
                <Link href={`/profile?id=${user.id}`}><Typography textAlign="center" >Profile</Typography></Link>
              </MenuItem>
              <MenuItem key="profile" onClick={handleCloseUserMenu}>
                <Link href={`/connections?id=${user.id}`}><Typography textAlign="center">Connections</Typography></Link>
              </MenuItem>
              <MenuItem key="profile" onClick={handleCloseUserMenu}>
